...
- [ ] 3.1 Implement GET /api/bookings endpoint
...
- [ ] 3.2 Implement POST /api/bookings endpoint
...
- [ ] 3.3 Implement GET /api/bookings/:id endpoint
...
- [ ] 3.4 Implement PATCH /api/bookings/:id endpoint
...
- [ ] 3.5 Implement GET /api/bookings/stats endpoint
...
- [ ] 3.6 Register bookings router in main application
...
- [ ] 4. Create BookingsPage frontend component
- [ ] 4.1 Create BookingsPage component structure
...
- [ ] 4.2 Implement booking list table
...
- [ ] 4.3 Implement filtering and search
...
- [ ] 4.5 Add create booking button
  - Add "Create Booking" button to page header
  - Implement onClick handler to open CreateBookingModal
  - _Requirements: 2.1_

- [ ] 5. Create CreateBookingModal component
- [ ] 5.1 Create modal structure and form state
...
- [ ] 5.2 Implement service and staff selection step
...
- [ ] 5.3 Implement slot selection step
...
- [ ] 5.4 Implement customer information step
...
- [ ] 6. Create BookingDetailsModal component
...
- [ ] 7. Add bookings navigation menu item
